      ...
      <section class="bg-[var(--surface-brand)] text-white">
        <div class="las-container py-12 md:py-16">
          ...
          >
            ...
            <span class="text-white font-semibold" aria-current="page">Get Involved</span>
          </nav>
          <h1
      ...
      <section class="las-section">
        <div class="las-container">
          ...
          >
            ...
            <UiButton href="/stewards-zone" variant="primary" icon-right="arrowRight">Stewards' zone</UiButton>
          </div>
        </div>
      </section>
